...
import { FiHome, FiUsers, FiBarChart2, FiSettings, FiPlusCircle, FiX } from 'react-icons/fi'
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="h-16 flex items-center justify-between px-4 border-b border-neutral-200 dark:border-neutral-700">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-lg font-bold text-primary-900 dark:text-white">Campus Connect</span>
              </div>
              <button
            ...
            <div className="px-4 py-4 border-b border-neutral-200 dark:border-neutral-700">
              ...
              <h2 className="mt-1 text-sm font-medium text-neutral-900 dark:text-white">{currentUser?.collage }</h2>
            </div>
