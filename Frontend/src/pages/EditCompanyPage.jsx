...
function EditCompanyPage() {
  ...
  useEffect(() => {
    ...
    if (foundCompany) {
      setCompany(JSON.parse(JSON.stringify(foundCompany))) // Deep copy
    } else {
      // Handle not found
  ...
  if (!company) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-2 text-neutral-600 dark:text-neutral-400">The company you're trying to edit doesn't exist or has been removed.</p>
        <Link 
  ...
  const handleSubmit = (e) => {
    ...
    // In a real app, this would be an API call
    console.log('Company data to update:', company)
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden dark:bg-neutral-800">
        <div className="p-6 border-b border-neutral-200 dark:border-neutral-700">
          <h1 className="text-xl font-semibold text-neutral-900 dark:text-white">Edit Company</h1>
          <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
            Update the details of {company.name}.
          </p>
        </div>
